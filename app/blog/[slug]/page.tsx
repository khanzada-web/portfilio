...
import * as prismaMod from '@/app/blog/content/prisma-connection-exhaustion-nextjs-16-accelerate'
import * as useClientMod from '@/app/blog/content/nextjs-16-stop-overusing-use-client-server-components'
import * as securityMod from '@/app/blog/content/nextjs-july-2026-security-patch-server-actions'
import * as saasMod from '@/app/blog/content/nextjs-16-saas-tutorial-prisma-typescript-2026'
...
const blogPosts: Record<string, BlogPost> = {
  ...
  'prisma-connection-exhaustion-nextjs-16-accelerate': fromMod(prismaMod),
  'nextjs-16-stop-overusing-use-client-server-components': fromMod(useClientMod),
  'nextjs-july-2026-security-patch-server-actions': fromMod(securityMod),
  'nextjs-16-saas-tutorial-prisma-typescript-2026': fromMod(saasMod),
