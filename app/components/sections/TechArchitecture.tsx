...
const LAYERS: Layer[] = [
  ...
  },
  {
    ...
    description: 'Robust server-side logic, REST & GraphQL APIs, JWT auth, and scalable database architectures.',
  },
  {
    title:       'Blockchain Layer',
    icon:        <FiLayers />,
    tech:        'Solidity, Ethers.js, Hardhat, IPFS, Web3.js',
    description: 'Smart contract development and decentralised storage integration for trustless apps.',
  },
  {
    title:       'Security & QA',
    icon:        <FiShield />,
    tech:        'Slither, Mythril, OpenZeppelin, JWT, SSL',
    description: 'Rigorous testing and auditing of contracts and APIs to ensure zero-vulnerability deployments.',
  },
  {
    title:       'DevOps Layer',
    icon:        <FiServer />,
    tech:        'Nginx, PM2, GitHub Actions, Certbot, WHM, Docker',
    description: 'Production-grade CI/CD pipelines, multi-site VPS management, email infrastructure (SPF, DKIM, DMARC), SSL setup, and domain/DNS configuration.',
  },
];
      ...
      <div className="container mx-auto px-6 max-w-5xl relative z-10">
        ...
        <div className="mb-16 text-center md:text-left space-y-4">
          <div className="flex items-center justify-center md:justify-start gap-3">
            ...
            <span className="text-[#39FF14]/60 text-xs tracking-[0.4em] uppercase">
              System_Architecture
            </span>
          </div>
        ...
        {/* Layer Grid
            5 layers: first 4 in a 2×2 grid, DevOps spans full width at the bottom */}
          ...
          {LAYERS.map((layer, index) => (
            <motion.div
              ...
              className={`group relative p-8 bg-white/5 border border-[#39FF14]/20 rounded-sm hover:border-[#39FF14] transition-all duration-500 ${
                // DevOps (index 4) spans both columns
              ...
              <div className="pt-5 border-t border-[#39FF14]/10 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <span
                    ...
                    aria-hidden="true"
                  />
                  <span className="text-[10px] uppercase tracking-widest text-[#39FF14]/60">
                    Stable.Build
                  </span>
                </div>
