          ...
          <div className="flex items-center">
            <Link href="/" className="flex items-center group font-orbitron font-bold text-xl sm:text-2xl text-gray-900 transition-all duration-300 hover:scale-105">
              <Image 
                ...
                priority
              />
              <span className="ml-2 sm:ml-3 bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent transition-all duration-300 group-hover:from-blue-600 group-hover:to-blue-800 hidden sm:inline">Mussawar Hayat</span>
              <span className="ml-2 bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent transition-all duration-300 group-hover:from-blue-600 group-hover:to-blue-800 sm:hidden">MH</span>
            </Link>
          </div>
