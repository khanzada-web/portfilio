...
export function Header() {
  ...
  // Always link to homepage contact section
      ...
      <div className="w-full px-4 sm:px-8"> 
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center space-x-7"> 
            {['Home', 'About', 'Services', 'Blog', 'Process', 'Portfolio', 'Testimonials'].map((item) => (
              <Link 
                key={item}
                href={item === 'Services' ? '/services' : item === 'Blog' ? '/blog' : `#${item.toLowerCase()}`} 
